function [particles,w,indx,lik]=bootstrap_LGSS_corr(y,D,Z,sigma_u,C,G,M,sigma_e,u_particles_init,u_particles,u_res,N)
...
for t=2:T
    ...
    [indx(t,:)]=rs_multinomial_corr2_PMMH_2ndorder_simplified(particles_com,w(t-1,:),u_res(t,:));
