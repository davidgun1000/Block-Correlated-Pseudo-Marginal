...
maxw_appr1 = max(lik_indv_appr1);
lik_appr1 = log(mean(exp(lik_indv_appr1-maxw_appr1)))+maxw_appr1; % average of the log likelihood
...
for i=1:nloop
    ...
    maxw_appr1_star = max(lik_indv_appr1_star);
    lik_appr1_star = log(mean(exp(lik_indv_appr1_star-maxw_appr1_star)))+maxw_appr1_star; % average of the log likelihood
...
%     end
    ...
    if mod(i,1000)==0
        save(['ParPMMH_appr1','dim',num2str(dim_y),'T',num2str(T),'N',num2str(N),'S',num2str(S),'.mat'],'Post');

    end
    
end
cputime=toc;
save(['ParPMMH_appr1','dim',num2str(dim_y),'T',num2str(T),'N',num2str(N),'S',num2str(S),'.mat'],'Post','cputime');
