...
for i=1:nloop
    ...
    lik_PF_star = lik_indv_appr1_median_star;
    %interacting step
    ...
    if mod(i,250)==0
       save(['ParPMMH_appr1_median','N',num2str(N),'S',num2str(S),'SmallScale_Datafull_disturbance.mat'],'Post');
