...
for i=1:nloop
    ...
    if mod(i,250)==0
       save(['ParPMMH_appr1_',num2str(trim_first),num2str(trim_second),'dim',num2str(dim_y),'T',num2str(T),'N',num2str(N),'S',num2str(S),'Diffusion_v2.mat'],'Post');
