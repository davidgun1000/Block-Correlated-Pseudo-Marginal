function [particles_eps,particles_first,particles_second,w,indx,lik]=Mix_smc_SmallScale_2ndorder_bootstrap_corr(A,B,H,Phi,R,S2,Phi11,Phi12,R00,omega_ss_delta,N,yt,...
    u_particles,u_res,state_var_positions,corr_index,disturbance_index)
