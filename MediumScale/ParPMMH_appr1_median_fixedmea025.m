...
param_BETA_EST=0.0664;
param_Gzest=0.4891;
param_pibar_est = 0.6696;
param_alpha=0.1557;
param_gamma=0.4808;
param_sigmaa=4.7040;
param_psiI=2.23;
param_psip_bar=100.1862/scale_psip;
param_psiw_bar=2128.5/scale_psiw;
param_sigmaL= 4.2444;
param_aest=0.4471;
param_awest=0.6473;
param_rhoR=0.4797;
param_gammapi=0.9911;
param_gammax=0.8720;
param_gammag=0.3907;
param_rhog=0.98;
param_rhomu=0.6596;
...
for i=1:nloop
    ...
    if result==1 & param_sigma_gest_star>0.005 & param_sigma_muest_star>0.005 & param_sigma_etaest_star>0.005 & param_sigma_zest_star>0.005 ...
            ...
            & param_rhomu_star>0.001 & param_rhomu_star<0.999
    ...
    if mod(i,250)==0
       save(['ParPMMH_appr1_median','N',num2str(N),'S',num2str(S),'mediumScale_DataReal_disturbance025.mat'],'Post');
