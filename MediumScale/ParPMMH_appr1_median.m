...
dynare medscalenew2 noclearall nolog
...
for i=1:nloop
    ...
    if result==1 & param_sigma_gest_star>0.005 & param_sigma_muest_star>0.005 & param_sigma_etaest_star>0.005 & param_sigma_zest_star>0.005 ...
            & param_sigma_rest_star>0.005 & param_rhoR_star>0.001 & param_rhoR_star<0.99 & param_rhog_star>0.001 & param_rhog_star<0.99 ...
            & param_rhomu_star>0.001 & param_rhomu_star<0.99 & param_sigma_measure1_bar_star>0.005 & param_sigma_measure2_bar_star>0.005 ...
    ...
    if mod(i,250)==0
       save(['ParPMMH_appr1_median','N',num2str(N),'S',num2str(S),'mediumScale_DataReal_disturbance.mat'],'Post');
